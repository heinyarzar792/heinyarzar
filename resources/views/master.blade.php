...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('front/frontend/css/media_query.css')}}">
...
<body>
    ...
    <script type="text/javascript" src="{{ asset('front/frontend/js/localstorage_custom.js')}}"></script>
